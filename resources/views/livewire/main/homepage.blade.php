            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div class="w-full lg:w-1/2 text-center lg:text-left z-10 -py-60">
                    ...
                    <p class="text-xl text-gray-100 mb-8 max-w-2xl">
                        Transform your financial future! Join our network of successful voucher card sellers and start
                        earning today. Easy registration, instant rewards.
                    </p>
                    @guest()
                        <p class="text-xl text-gray-100 mb-8 max-w-2xl">

                            Want to sell Voucher Card? Click on the the button below
                        </p>
                    @endguest
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        @guest()
                            <a href="{{route('login')}}"
                               class="inline-flex items-center px-8 py-4 rounded-full bg-gradient-to-r from-green-400 to-yellow-400 text-gray-900 font-bold text-lg transform transition hover:scale-105 hover:shadow-2xl">
                                Start Earning Now
                        ...
                        <a href="{{route('users.home')}}"
                           class="inline-flex items-center px-8 py-4 rounded-full border-2 border-white text-white font-bold text-lg hover:bg-white hover:text-gray-900 transition-colors">
                            Learn More
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2 z-10">
                    <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-2xl float-animation">
                        ...
                        <div class="flex justify-center">
                            <a href=""
                               class="inline-block px-8 py-4 rounded-xl bg-gradient-to-r from-green-400 to-yellow-400 text-gray-900 font-bold text-lg transform transition hover:scale-105 hover:shadow-xl">
                                Verify Now
                            </a>
                        </div>
