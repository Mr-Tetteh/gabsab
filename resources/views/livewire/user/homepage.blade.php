                        ...
                        <div class="relative bg-white p-6 rounded-3xl shadow-lg overflow-hidden">
                            ...
                            <div class="relative z-10 text-center">
                                ...
                                @if(Auth::user())
                                    ...
                                    <a href="{{route('admin.data')}}"
                                       class="group inline-flex items-center justify-center w-full py-4 px-6 bg-gradient-to-r from-{{ ['fuchsia', 'violet', 'zinc', 'cyan'][$index % 3] }}-500 to-{{ ['fuchsia', 'violet', 'zinc', 'cyan'][$index % 3] }}-600 text-white font-bold rounded-xl transition-all duration-300 hover:shadow-xl hover:scale-105">
                                        Choose Plan
                                        <svg
                                            class="ml-3 w-6 h-6 transform group-hover:translate-x-1 transition-transform"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                ...
                                @else
                                    <a href="{{route('dashboard')}}"
                                       class="group inline-flex items-center justify-center w-full py-4 px-6 bg-gradient-to-r from-{{ ['fuchsia', 'yellow', 'zinc', 'cyan'][$index % 3] }}-500 to-{{ ['fuchsia', 'yellow', 'zinc', 'cyan'][$index % 3] }}-600 text-white font-bold rounded-xl transition-all duration-300 hover:shadow-xl hover:scale-105">
                                        Choose Plan
                                        <svg
                                            class="ml-3 w-6 h-6 transform group-hover:translate-x-1 transition-transform"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24"
